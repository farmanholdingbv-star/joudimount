...
export default function App() {
    ...
    return (_jsxs(_Fragment, { children: [!user ? (_jsx("header", { className: "app-header container py-3", children: _jsxs("div", { className: "d-flex align-items-center justify-content-between flex-wrap gap-3", children: [_jsx("img", { src: "/logo.png", alt: "Project logo", width: 66, height: 66, className: "app-logo flex-shrink-0" }), _jsx("div", { className: "d-flex align-items-center flex-wrap gap-3 justify-content-end ms-auto", children: _jsx(LanguageSwitcher, {}) })] }) })) : null, !user ? (_jsx(Login, { onLogin: setUser })) : (_jsx(AuthenticatedRoutes, { user: user, onLogout: handleLogout }))] }));
}
