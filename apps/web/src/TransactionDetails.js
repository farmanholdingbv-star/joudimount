...
export default function TransactionDetails({ role }) {
    ...
    return (_jsxs("main", { className: "container", children: [_jsxs("div", { className: "page-actions", children: [_jsx(Link, { to: "/", className: "link-button", children: t("details.back") }), id ? (_jsxs(_Fragment, { children: [" | ", role !== "accountant" ? (_jsxs(_Fragment, { children: [_jsx(Link, { to: `/transactions/${id}/edit`, className: "link-button", children: t("details.edit") }), " | ", _jsx("button", { className: "danger-button", onClick: onDelete, disabled: deleting, children: deleting ? t("details.deleting") : t("details.delete") })] })) : null, role === "manager" || role === "accountant" ? (_jsxs(_Fragment, { children: [" | ", _jsx("button", { className: "primary-button", onClick: () => onAccountingAction("pay"), disabled: processing || transaction?.paymentStatus === "paid", children: t("details.markPaid") }), " ", _jsx("button", { className: "primary-button", onClick: () => onAccountingAction("release"), disabled: processing ||
                                            ...
                                            (transaction?.documentStatus !== "original_received" && transaction?.documentStatus !== "telex_release"), children: t("details.release") })] })) : null, transaction ? (_jsxs(_Fragment, { children: [" | ", _jsx("button", { type: "button", className: "primary-button", onClick: () => setShippingPaperOpen(true), children: t("details.shippingPaperButton") })] })) : null] })) : null] }), _jsx("h1", { children: t("details.title") }), error ? _jsx("p", { className: "error", children: error }) : null, !transaction && !error ? _jsx("p", { children: t("details.loading") }) : null, transaction && (_jsx("section", { className: "details-card", children: _jsxs("div", { className: "details-grid", children: [_jsxs("p", { className: "details-item", children: [_jsxs("strong", { children: [t("details.client"), ":"] }), " ", transaction.clientName] }), _jsxs("p", { className: "details-item", children: [_jsxs("strong", { children: [t("details.shippingCompany"), ":"] }), " ", transaction.shippingCompanyName] }), _jsxs("p", { className: "details-item", children: [_jsxs("strong", { children: [t("details.createdAt"), ":"] }), " ", new Date(transaction.createdAt).toLocaleString(numberLocale)] }), _jsxs("p", { className: "details-item", children: [_jsxs("strong", { children: [t("details.airwayBill"), ":"] }), " ", transaction.airwayBill] }), _jsxs("p", { className: "details-item", children: [_jsxs("strong", { children: [t("details.hsCode"), ":"] }), " ", transaction.hsCode] }), _jsxs("p", { className: "details-item", children: [_jsxs("strong", { children: [t("details.goods"), ":"] }), " ", transaction.goodsDescription] }), _jsxs("p", { className: "details-item", children: [_jsxs("strong", { children: [t("details.origin"), ":"] }), " ", transaction.originCountry] }), _jsxs("p", { className: "details-item", children: [_jsxs("strong", { children: [t("details.duty"), ":"] }), " ", transaction.customsDuty.toLocaleString(numberLocale), " ", t("details.currencySuffix")] }), _jsxs("p", { className: "details-item", children: [_jsxs("strong", { children: [t("details.document"), ":"] }), " ", transaction.documentStatus] }), _jsxs("p", { className: "details-item", children: [_jsxs("strong", { children: [t("details.status"), ":"] }), " ", transaction.clearanceStatus] }), _jsxs("p", { className: "details-item", children: [_jsxs("strong", { children: [t("details.payment"), ":"] }), " ", transaction.paymentStatus] }), transaction.containerCount != null ? (_jsxs("p", { className: "details-item", children: [_jsxs("strong", { children: [t("details.containerCount"), ":"] }), " ", transaction.containerCount] })) : null, transaction.goodsWeightKg != null ? (_jsxs("p", { className: "details-item", children: [_jsxs("strong", { children: [t("details.goodsWeightKg"), ":"] }), " ", transaction.goodsWeightKg.toLocaleString(numberLocale)] })) : null, transaction.invoiceToWeightRateAedPerKg != null ? (_jsxs("p", { className: "details-item", children: [_jsxs("strong", { children: [t("details.invoiceToWeightRate"), ":"] }), " ", transaction.invoiceToWeightRateAedPerKg.toLocaleString(numberLocale)] })) : null, transaction.containerArrivalDate ? (_jsxs("p", { className: "details-item", children: [_jsxs("strong", { children: [t("details.containerArrivalDate"), ":"] }), " ", new Date(transaction.containerArrivalDate).toLocaleString(numberLocale)] })) : null, transaction.documentArrivalDate ? (_jsxs("p", { className: "details-item", children: [_jsxs("strong", { children: [t("details.documentArrivalDate"), ":"] }), " ", new Date(transaction.documentArrivalDate).toLocaleString(numberLocale)] })) : null, transaction.fileNumber ? (_jsxs("p", { className: "details-item", children: [_jsx("strong", { children: "File Number:" }), " ", transaction.fileNumber] })) : null, transaction.containerNumbers && transaction.containerNumbers.length > 0 ? (_jsxs("p", { className: "details-item", children: [_jsx("strong", { children: "Container Numbers:" }), " ", transaction.containerNumbers.join(", ")] })) : null, transaction.unitCount != null ? (_jsxs("p", { className: "details-item", children: [_jsx("strong", { children: "Number of Units:" }), " ", transaction.unitCount] })) : null, _jsxs("p", { className: "details-item", children: [_jsx("strong", { children: "Stopped:" }), " ", transaction.isStopped ? "Yes" : "No"] }), transaction.holdReason ? (_jsxs("p", { className: "details-item", children: [_jsx("strong", { children: "Hold Reason:" }), " ", transaction.holdReason] })) : null, transaction.isStopped && transaction.stopReason ? (_jsxs("p", { className: "details-item", children: [_jsx("strong", { children: "Stop Reason:" }), " ", transaction.stopReason] })) : null, transaction.goodsQuantity != null ? (_jsxs("p", { className: "details-item", children: [_jsxs("strong", { children: [t("details.goodsQuantity"), ":"] }), " ", transaction.goodsQuantity.toLocaleString(numberLocale)] })) : null, transaction.goodsUnit ? (_jsxs("p", { className: "details-item", children: [_jsxs("strong", { children: [t("details.goodsUnit"), ":"] }), " ", t(`form.unit.${transaction.goodsUnit}`)] })) : null, transaction.documentAttachments && transaction.documentAttachments.length > 0 ? (_jsxs("div", { className: "details-item full-row", children: [_jsx("p", { children: _jsx("strong", { children: t("details.documentPhotos") }) }), _jsx("ul", { className: "attachment-grid", children: transaction.documentAttachments.map((a) => {
